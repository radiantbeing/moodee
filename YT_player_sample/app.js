...
async function createPlayer() {
  ...
  const playlist = await getPlaylist(theme, "music.json");
...
function createControllers() {
  ...
  controlComponents[0].addEventListener("click", volumeDownHandler);
  controlComponents[1].addEventListener("click", playPrevHandler);
  controlComponents[2].addEventListener("click", () => player.playVideo());
  controlComponents[3].addEventListener("click", playNextHandler);
  controlComponents[4].addEventListener("click", volumeUpHandler);
}
...
function playHandler() {
  ...
  new_pauseBtn.addEventListener("click", () => player.pauseVideo());
...
function pauseHandler() {
  ...
  new_playBtn.addEventListener("click", () => player.playVideo());
 ...
 */
(async function main() {
  await autoCreateThemeSelector("music.json");
  loadYoutubeAPI();
})();
